...
const qualifications = [
  {
    ...
    description: "Leading a team of researchers focused on climate solutions and sustainable development.",
    icon: Briefcase,
    type: "work",
  },
  {
  ...
  },
  {
    ...
    description: "Graduated summa cum laude with honors in environmental biology.",
    icon: GraduationCap,
    type: "education",
  },
]
